...
public class Income_Expense_Fragment extends Fragment {
    ...
    public Income_Expense_Fragment() {
    }
...
//        });
        ...
        myData.addAll(DatabaseHelper.getInstance(context).getOverallDataInformation(DatabaseHelper.TABLE_EXPENSE, "expenseName", "expenseName, SUM(expenseAmount)"));
